...
var VolumeSnapshotDataRenderer = volumeSnapshotDataRenderer{}

type volumeSnapshotDataRenderer struct{}

func (v volumeSnapshotDataRenderer) Render(rpt report.Report) Nodes {
	nodes := make(report.Nodes)
