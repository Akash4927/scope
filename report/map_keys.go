...
const (
	...
	KubernetesDescribePod                  = "kubernetes_describe_pod"
	KubernetesDescribeService              = "kubernetes_describe_service"
	KubernetesCronjob                      = "kubernetes_describe_cron_job"
	KubernetesDescribeDeployment           = "kubernetes_describe_deployment"
	KubernetesDescribeDaemonSet            = "kubernetes_describe_daemon_set"
	KubernetesDescribePVC                  = "kubernetes_describe_pvc"
	KubernetesDescribePV                   = "kubernetes_describe_pv"
	KubernetesDescribeSC                   = "kubernetes_describe_sc"
	KubernetesDescribeStatefulSet          = "kubernetes_describe_stateful_set"
	// probe/awsecs
